        ...
        var domTree_Img =
          ...
          (function () {
            ...
            _proto3.toMarkup = function toMarkup() {
              var markup =
                "<img  src='" + this.src + " 'alt='" + this.alt + "' "; // Add the styles, after hyphenation
 ...
 */
        ...
        var wide_character_wideCharacterFont = function wideCharacterFont(
          wideChar,
          mode
        ) {
        ...
        var buildCommon_lookupSymbol = function lookupSymbol(
        ...
        var buildCommon_makeSymbol = function makeSymbol(
          value,
          fontName,
          mode,
          options,
        ...
        var buildCommon_mathsym = function mathsym(
          value,
          mode,
          options,
          classes
        ...
        var buildCommon_mathdefault = function mathdefault(
          value,
          mode,
          options,
          classes
        ...
        var buildCommon_mathnormal = function mathnormal(
          value,
          mode,
          options,
          classes
        ...
        var buildCommon_makeOrd = function makeOrd(group, options, type) {
          ...
          if (text.charCodeAt(0) === 0xd835) {
            ...
            var _wideCharacterFont = wide_character_wideCharacterFont(
                text,
                mode
              ),
          ...
          if (type === "mathord") {
            var fontLookup = buildCommon_mathdefault(
              text,
              mode,
              options,
              classes
        ...
        var buildCommon_makeSpan = function makeSpan(
          classes,
          children,
          options,
          style
        ...
        var buildCommon_makeSvgSpan = function makeSvgSpan(
          classes,
          children,
          options,
          style
        ...
        var buildCommon_makeAnchor = function makeAnchor(
          href,
          classes,
          children,
          options
        ...
        var getVListChildrenAndDepth = function getVListChildrenAndDepth(
          params
        ) {
        ...
        var buildCommon_makeVList = function makeVList(params, options) {
          ...
          for (var _i2 = 0; _i2 < children.length; _i2++) {
            ...
            if (_child.type === "kern") {
              ...
              var childWrap = buildCommon_makeSpan(
                classes,
                [pstrut, _elem],
                undefined,
                style
          ...
          if (minPos < 0) {
            ...
            var topStrut = buildCommon_makeSpan(
              ["vlist-s"],
         ...
         */
        var buildHTML_buildExpression = function buildExpression(
          expression,
          options,
          isRealGroup,
          surrounding
        ...
        var buildMathML_buildExpression = function buildExpression(
          ...
          for (var i = 0; i < expression.length; i++) {
            ...
            if (
              _group instanceof mathMLTree_MathNode &&
              ...
              if (
                ...
                if (
                  lastChild instanceof mathMLTree_TextNode &&
                  lastChild.text === "\u0338" &&
                  (_group.type === "mo" ||
                    _group.type === "mi" ||
                    _group.type === "mn")
                  ...
                  if (
                    _child instanceof mathMLTree_TextNode &&
                    _child.text.length > 0
                  ) {
        ...
        var buildTree_optionsFromSettings = function optionsFromSettings(
          settings
        ) {
        ...
        var buildTree_buildTree = function buildTree(
          tree,
          expression,
          settings
        ) {
        ...
        var buildTree_buildHTMLTree = function buildHTMLTree(
          tree,
          expression,
          settings
        ) {
        ...
        var stretchy_encloseSpan = function encloseSpan(
          inner,
          label,
          pad,
          options
        ...
        var accent_htmlBuilder = function htmlBuilder(grp, options) {
          ...
          if (mustShift) {
            ...
            var baseGroup = buildHTML_buildGroup(
              baseChar,
        ...
        defineFunction({
          ...
          mathmlBuilder: function mathmlBuilder(group, options) {
            ...
            if (group.body) {
              var upperNode = arrow_paddedNode(
                buildMathML_buildGroup(group.body, options)
              );

              if (group.below) {
                var lowerNode = arrow_paddedNode(
              ...
              var _lowerNode = arrow_paddedNode(
                buildMathML_buildGroup(group.below, options)
              );
        ...
        var color_htmlBuilder = function htmlBuilder(group, options) {
          var elements = buildHTML_buildExpression(
            group.body,
        ...
        var delimiter_styleWrap = function styleWrap(
          delim,
          toStyle,
          options,
          classes
        ...
        var delimiter_makeSmallDelim = function makeSmallDelim(
          delim,
          style,
          center,
          options,
        ...
        var delimiter_mathrmSize = function mathrmSize(
          value,
          size,
          mode,
          options
        ...
        var delimiter_makeLargeDelim = function makeLargeDelim(
          delim,
          size,
          center,
          options,
        ...
        var delimiter_makeStackedDelim = function makeStackedDelim(
          delim,
          heightTotal,
          center,
          options,
          ...
          var shiftOfExtraElement =
            (repeatCount + 1) * 0.005 - repeatHeightTotal; // Now, we start building the pieces that will go into the vlist
        ...
        var delimiter_sqrtSvg = function sqrtSvg(
          sqrtName,
          height,
          viewBoxHeight,
          extraViniculum,
        ...
        var delimiter_makeSizedDelim = function makeSizedDelim(
          delim,
          size,
          options,
          mode,
        ...
        var traverseSequence = function traverseSequence(
          ...
          for (var i = start; i < sequence.length; i++) {
            ...
            var metrics = delimiter_getMetrics(
              delim,
        ...
        var delimiter_makeCustomSizedDelim = function makeCustomSizedDelim(
          delim,
          height,
          center,
          options,
        ...
        var array_htmlBuilder = function htmlBuilder(group, options) {
          ...
          if (group.colSeparationType && group.colSeparationType === "small") {
            ...
            var localMultiplier = options.havingStyle(src_Style.SCRIPT)
              .sizeMultiplier;
        ...
        var mathchoice_chooseMathStyle = function chooseMathStyle(
          group,
          options
        ) {
        ...
        var assembleSupSub_assembleSupSub = function assembleSupSub(
          base,
          supGroup,
          subGroup,
          options,
          ...
          if (subGroup) {
            var _elem = buildHTML_buildGroup(
              subGroup,
              options.havingStyle(style.sub()),
              options
            );
        ...
        var op_mathmlBuilder = function mathmlBuilder(group, options) {
          ...
          if (group.symbol) {
            ...
            var operator = new mathMLTree_MathNode("mo", [
              buildMathML_makeText("\u2061", "text"),
            ]);
        ...
        var operatorname_htmlBuilder = function htmlBuilder(grp, options) {
          ...
          if (group.body.length > 0) {
            ...
            var expression = buildHTML_buildExpression(
              body,
        ...
        var operatorname_mathmlBuilder = function mathmlBuilder(
          group,
          options
        ) {
          ...
          htmlBuilder: function htmlBuilder(group, options) {
            if (group.semisimple) {
              return buildCommon.makeFragment(
                buildHTML_buildExpression(group.body, options, false)
              );
            }
        ...
        defineFunction({
          ...
          htmlBuilder: function htmlBuilder(group, options) {
            ...
            var innerGroup = buildHTML_buildGroup(
              group.body,
              options.havingCrampedStyle()
            ...
            var defaultRuleThickness = options.fontMetrics()
        ...
        defineFunction({
          ...
          htmlBuilder: function htmlBuilder(group, options) {
            ...
            var width = units_calculateSize(group.width, options);
            var height = units_calculateSize(group.height, options);
            var shift = group.shift
              ? units_calculateSize(group.shift, options)
              : 0; // Style the rule to the right size
        ...
        defineFunction({
          ...
          htmlBuilder: function htmlBuilder(group, options) {
            ...
            // and line
            var inner = buildHTML_buildGroup(
              group.body,
              options.havingCrampedStyle()
            );
            ...
            if (!group.index) {
              ...
              var rootm = buildHTML_buildGroup(
                group.index,
                newOptions,
                options
         ...
         */
        var supsub_htmlBuilderDelegate = function htmlBuilderDelegate(
          group,
          options
        ) {
          var base = group.base;
        ...
        var controlWordWhitespaceRegex = new RegExp(
          "^(" + controlWordRegexString + ")" + spaceRegexString + "*$"
        );
        ...
        var macros_newcommand = function newcommand(
          context,
          existsOK,
          nonexistsOK
        ) {
          ...
          (function () {
            ...
            _proto.parseArguments = function parseArguments(
              ...
              for (var i = 0; i < totalArgs; i++) {
                ...
                var consumeSpaces =
                  (i > 0 && !isOptional) || // Also consume leading spaces in math mode, as parseSymbol
            ...
            _proto.parseStringGroup = function parseStringGroup(
              ...
              while (
                (nextToken = this.fetch()).text !== groupEnd ||
                (raw && nested > 0)
              ) {
            ...
            _proto.parseUrlGroup = function parseUrlGroup(
              optional,
              consumeSpaces
            ) {
        ...
        var katex_generateParseTree = function generateParseTree(
          expression,
          options
        ) {
        ...
        var katex_renderError = function renderError(
          error,
          expression,
          options
        ) {
        ...
        var katex_renderToHTMLTree = function renderToHTMLTree(
          expression,
          options
        ) {
          var settings = new Settings_Settings(options);
        ...
        /* harmony default export */ var katex_webpack = (__webpack_exports__[
          "default"
        ] = katex_0);
